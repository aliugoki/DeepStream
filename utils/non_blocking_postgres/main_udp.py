...
# ==============================================================================
# --- RTSP Server Classes (unchanged from your version) ---
# ==============================================================================
...
def main(cfg):
    ...
    # --- Add sources and streammux config (same as your logic) ---
    ...
    # RTSP branch (if enabled) - unchanged
    ...
    attach_sgie_probe(sgie, known_face_features, attendance_queue, save_path, sources)
